    ...
    <div class="container-full">
        <div class="form-section">
            ...
            <div class="text-center mb-4">
                <h2 class="fw-bold">Selamat Datang di Gipstore</h2>
                <p class="text-muted">Silakan masukkan detail Anda</p>
            </div>
            ...
            <form method="POST" action="{{ route('client.login.submit') }}" id="loginForm">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="password" name="password" id="password" class="form-control rounded-pill @error('password') is-invalid @enderror" placeholder="Masukkan Kata Sandi Anda" required autocomplete="current-password">
                ...
                <div class="text-center text-small mt-4">
                    Belum punya akun? <a href="{{ route('client.register') }}" class="text-primary">Daftar sekarang</a>
                </div>
            </form>
        </div>
